      ...
      <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 11 }}>
        <thead>
          <tr style={{ background: "#f1f1f1" }}>
            ...
            <th style={{ ...thStyle, color: "#2e7d32", fontWeight: 800, fontSize: 12 }}>Prévision (Q50)</th>
            <th style={thStyle}>Intervalle (Range)</th>
            ...
            return (
              <tr key={d.date} style={{
                ...
                <td style={{ ...tdStyle, color: "#555" }}>
                  {d.q50.toFixed(0)} <span style={{ color: "#777", fontSize: 11 }}>± {(spread / 2).toFixed(0)}</span>
                  <span style={{ color: "#999", fontSize: 10, marginLeft: 6 }}>({d.q10.toFixed(0)} - {d.q90.toFixed(0)})</span>
                </td>
                <td style={{ ...tdStyle }}>
                  <span style={{
